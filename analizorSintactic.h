...
bool unit(){
    ...
    tkerr(iTk, "Unexpected token in unit()");
}
        ...
        if(consume(ID)){
            if(consume(LPAR)){
               ...
               if(consume(RPAR)){
                   ...
                   tkerr(iTk, "Expected stmCompound()");
               }
               tkerr(iTk, "Expected RPAR");
            }
        }
    }
    iTk = start;
        ...
        if(consume(LPAR)){
            if(expr()){
                if(consume(RPAR)){
                    ...
                    tkerr(iTk, "Expected stm()");
                }
                tkerr(iTk, "Expected RPAR");
            }
            tkerr(iTk, "Expected expr()");
        }
        tkerr(iTk, "Expected LPAR");
            ...
            if(consume(SEMICOLON)){
                ...
                if(consume(SEMICOLON)){
                    ...
                    if(consume(RPAR)){
                        ...
                        tkerr(iTk, "Expexted stm()");
                    }
                    tkerr(iTk, "Expected RPAR");
                }
                tkerr(iTk, "Expected SEMICOLON");
            }
            tkerr(iTk, "Expexted SEMICOLON");
        }
        tkerr(iTk, "Expected LPAR");
    }
...
bool exprOrPrim(){
    ...
    if(consume(OR)){ // prima alternativă: OR exprAnd exprOrPrim
        if(exprAnd()){
            ...
            tkerr(iTk, "Expected exprOrPrim()");
            
        }
        tkerr(iTk, "Expected exprAnd()");
    }
...
bool exprAndPrim(){
    ...
    if(consume(AND)){
        if(exprEq()){
            ...
            tkerr(iTk, "Expected exprAndPrim()");
        }
        tkerr(iTk, "Expected expEq()");
    }
...
bool exprEqPrim(){
    ...
    if(consume(EQUAL) || consume(NOTEQ)){
        if(exprRel()){
            ...
            tkerr(iTk, "Expected exprEqPrim()");

        }
        tkerr(iTk, "Expected exprRel()");
    }
...
bool exprRelPrim(){
    ...
    if(consume(LESS) || consume(LESSEQ) || consume(GREATER) || consume(GREATEREQ)){
        if(exprAdd()){
            ...
            tkerr(iTk, "Expected exprRelPrim()");
        }
        tkerr(iTk, "Expected exprAdd()");
    }
...
bool exprAddPrim(){
    ...
    if(consume(ADD) || consume(SUB)){
        if(exprMul()){
            ...
            tkerr(iTk, "Expected exprAddPrim()");
        }
        tkerr(iTk, "Expected exprMul()");
    }
    return true;
}
...
bool exprMulPrim(){
    ...
    if(consume(MUL) || consume(DIV)){
        if(exprCast()){
            ...
            tkerr(iTk, "Expected exprMulPrim()");
        }
        tkerr(iTk, "Expected exprCast()");
    }
...
bool exprPostfix(){
    ...
    if(exprPrimary()){
        ...
        tkerr(iTk, "Expected exprPostFix()");
    }
    iTk = start;
    return false;
}
    ...
    if(consume(LBRACKET)){
        if(expr()){
            if(consume(RBRACKET)){
                ...
                tkerr(iTk, "Expected exprPostfixPrim()");
            }
            tkerr(iTk, "Expected RBRACKET()");
        }
        tkerr(iTk, "Expected expr()");
    }
    ...
    if(consume(ID)){
        if(consume(LPAR)){
            if(expr()){
                while(consume(COMMA)){
                    if(!expr()) 
                        tkerr(iTk,"This expression expected expr()");
                }
            }
            if(!consume(RPAR)) 
                return false;
